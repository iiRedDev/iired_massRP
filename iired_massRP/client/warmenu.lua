...
local function drawTitle()
	if menus[currentMenu] then
        ...
        DrawSprite("menu_textures", "translate_bg_1a", 0.20, 0.35, 0.30, 0.35, 0.8, 000, 2, 2, 200, 1)
        DrawSprite("menu_textures", "translate_bg_1a", 0.20, 0.1, 0.30, 0.1, 0.1, 200, 1, 1, 150, 0)
